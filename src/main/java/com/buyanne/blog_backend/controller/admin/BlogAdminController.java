...
//		commentService.deleteCommentsByBlogId(id);
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody com.buyanne.blog_backend.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody com.buyanne.blog_backend.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(com.buyanne.blog_backend.model.dto.Blog blog, String type) {
		//验证普通字段

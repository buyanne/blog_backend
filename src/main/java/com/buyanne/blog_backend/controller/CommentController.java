...
import com.buyanne.blog_backend.model.dto.Comment;
...
import com.buyanne.blog_backend.service.FriendService;
import com.buyanne.blog_backend.service.impl.UserServiceImpl;
import com.buyanne.blog_backend.util.*;
...
public class CommentController {
	...
	public Result postComment(@RequestBody Comment comment,
		...
		//父评论
		com.buyanne.blog_backend.entity.Comment parentComment = null;
	 ...
	 */
	private void judgeSendMail(Comment comment, boolean isVisitorComment, com.buyanne.blog_backend.entity.Comment parentComment) {
	 ...
	 * @param comment       当前评论
	 */
	private void sendMailToParentComment(com.buyanne.blog_backend.entity.Comment parentComment, Comment comment) {
		String path = "";
		String title = "";
		if (comment.getPage() == 0) {
			//普通博客
